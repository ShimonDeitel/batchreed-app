        ...
        NavigationStack {
            ZStack {
                ...
                VStack(spacing: 24) {
                    ...
                    Text("Batch Reed Pro")
                        .font(BRTheme.titleFont)
                        .foregroundStyle(BRTheme.ink)

                    VStack(alignment: .leading, spacing: 14) {
                        featureRow("infinity", "Unlimited entries")
                        featureRow("star.fill", "Reed Soak Timer")
                        featureRow("checkmark.seal.fill", "Soak timers with material quantity calculator per basket size.")
                    }
